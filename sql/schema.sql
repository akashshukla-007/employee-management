...
-- Multi-file document storage for Joining Forms and F11 forms, linked to an
-- employee by Employee ID (see also sql/migrations/002_employee_documents.sql
-- for existing databases created before this table existed).
